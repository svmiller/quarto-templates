...
$if(two-teachers)$ % this is as much else-if as Pandoc can do. If two-author...
$if(by-author/allbutlast)$
$for(by-author/allbutlast)$
{$by-author.name.literal$}$sep$$endfor$
$for(by-author/last)$
{ and $by-author.name.literal$}$endfor$
$else$
${by-author.name/last}
$endif$

$elseif(n-teachers)$ % else-if it's n-teachers...
$if(by-author/allbutlast)$
$for(by-author/allbutlast)$
{$by-author.name.literal$}$sep$, $endfor$,
$for(by-author/last)$
...
$else$ % default else is that it's one teacher...
